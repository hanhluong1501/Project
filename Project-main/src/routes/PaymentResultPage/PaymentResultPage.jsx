...
import {
  ...
  updatePaymentStatus,
  deleteOrder,
} from "server/firebase/firestore/orders";
    ...
    const action = async () => {
      try {
        ...
        if (
          ...
          showSuccessToast(
            "🎉 Thanh toán thành công! Cảm ơn bạn đã mua sắm tại Beauty Garden."
          );
              ...
              {resultCode === "0" && (
                <>
                  <Typography variant="subtitle1">
                    Mã đơn hàng của bạn là #<b>{orderId}</b>. Cám ơn bạn đã lựa
                    chọn và luôn tin tưởng Beauty Garden.
                  </Typography>
