    ...
    switch (key) {
        ...
        switch (value) {
          ...
          case 1:
            return (
              <Box>
                <Typography>
                  Chú ý! Có vấn đề với bọng mắt của bạn. Hãy khám phá các sản
                  phẩm chăm sóc da của chúng tôi để cải thiện tình trạng này.
                </Typography>
        ...
        switch (value) {
          ...
          case 1:
            return (
              <Box>
                <Typography>
                  Phát hiện quầng thâm mắt. Hãy khám phá ngay sản phẩm chăm sóc
                  da chuyên sâu để giảm quầng thâm và làm tươi mới đôi mắt của
                  bạn.
                </Typography>
                <Link to={CATEGORY_PATH.SKINCARE}>
                  <Button
        ...
        switch (value) {
          ...
          case 1:
            return (
              <Box>
                <Typography>
                  Oops! Nếp nhăn trán đã xuất hiện. Hãy khám phá ngay các sản
                  phẩm chăm sóc da chống lão hóa để giảm nếp nhăn và giữ cho làn
                  da trán của bạn trông trẻ trung hơn.
                </Typography>
                <Link to={CATEGORY_PATH.SKINCARE}>
                  <Button
                    variant="contained"
        ...
        switch (value) {
          ...
          case 1:
            return (
              <Box>
                <Typography>
                  Uh oh! Có vẻ đây là vết chân chim. Bạn có thể quan tâm đến sản
                  phẩm chăm sóc da để giảm thiểu vết chân chim và tái tạo làn da
                  xung quanh mắt.
                </Typography>
                <Link to={CATEGORY_PATH.SKINCARE}>
                  <Button
      ...
      case SKIN_ANALYSIS_LABEL.eye_finelines:
        switch (value) {
          case 0:
            return (
              <Typography variant="h6">Không có nếp nhăn vùng mắt</Typography>
            );
          case 1:
            return (
              <Box>
                <Typography>
                  Có vấn đề với nếp nhăn vùng mắt. Hãy khám phá ngay các sản
                  phẩm chăm sóc da chống lão hóa để giảm thiểu nếp nhăn và làm
                  cho vùng mắt trở nên trẻ trung hơn.
                </Typography>
                <Link to={CATEGORY_PATH.SKINCARE}>
                  <Button
                    variant="contained"
        ...
        switch (value) {
          ...
          case 1:
            return (
              <Box>
                <Typography>
                  Có vấn đề với lỗ chân lông trán. Hãy khám phá ngay các sản
                  phẩm chăm sóc da để giảm tiết dầu và làm se lỗ chân lông.
                </Typography>
                <Link to={CATEGORY_PATH.SKINCARE}>
                  <Button
                    variant="contained"
        ...
        switch (value) {
          ...
          case 1:
            return (
              <Box>
                <Typography>
                  Có vấn đề với lỗ chân lông. Bạn có thể quan tâm đến sản phẩm
                  chăm sóc da của chúng tôi.
                </Typography>
                <Link to={CATEGORY_PATH.SKINCARE}>
                  <Button
                    variant="contained"
      ...
      case SKIN_ANALYSIS_LABEL.pores_jaw:
        switch (value) {
          case 0:
            return (
              <Typography variant="h6">Cằm không nhiều lỗ chân lông</Typography>
            );
          case 1:
            return (
              <Box>
                <Typography>
                  Có vấn đề. Bạn có thể quan tâm đến các sản phẩm chăm sóc da để
                  giảm thiểu lỗ chân lông.
                </Typography>
                <Link to={CATEGORY_PATH.SKINCARE}>
                  <Button
                    variant="contained"
        ...
        switch (value) {
          ...
          case 1:
            return (
              <Box>
                <Typography>
                  Có vấn đề. Bạn có thể quan tâm đến sản phẩm chăm sóc da để
                  loại bỏ mụn đầu đen.
                </Typography>
                <Link to={CATEGORY_PATH.SKINCARE}>
                  <Button
        ...
        switch (value) {
          ...
          case 1:
            return (
              <Box>
                <Typography>
                  Có vấn đề với mụn. Bạn có thể quan tâm đến sản phẩm chăm sóc
                  da để làm dịu và kiểm soát tình trạng mụn.
                </Typography>
                <Link to={CATEGORY_PATH.SKINCARE}>
                  <Button
                    variant="contained"
        ...
        switch (value) {
          ...
          case 1:
            return (
              <Box>
                <Typography>
                  Có vấn đề với nám. Bạn có thể quan tâm đến các sản phẩm chăm
                  sóc da để giảm thiểu và làm mờ nám da.
                </Typography>
                <Link to={CATEGORY_PATH.SKINCARE}>
                  <Button
                    variant="contained"
        ...
        <AccordionDetails>
          <Typography>
            {value !== undefined && confidence !== undefined && (
              <span>
                <i>{description} </i> ({(confidence * 100).toFixed(2)}% Độ chính
                xác)
              </span>
            )}
          </Typography>
