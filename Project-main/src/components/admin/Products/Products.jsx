...
export default function Products() {
  ...
  const emptyRows =
    page > 0
      ? Math.max(0, (1 + page) * rowsPerPage - sortedProducts.length)
      : 0;
      ...
      <Grid item xs={12}>
        ...
        >
          ...
          >
            ...
            <MenuItem value={CATEGORY.MAKE_UP}>Trang điểm</MenuItem>
            <MenuItem value={CATEGORY.SKINCARE}>Chăm sóc da</MenuItem>
            <MenuItem value={CATEGORY.GIFTS_AND_SETS}>Quà tặng & Bộ</MenuItem>
          </Select>
        </Box>
        <TableContainer component={Paper}>
          <Table
            sx={{ minWidth: 500, marginBlock: 4 }}
        ...
        <ConfirmDialog
          ...
          content={
            <>
              ...
              <Typography variant="body2" color="textSecondary">
                Hành động này không thể được hoàn tác. Hãy chắc chắn rằng bạn
                thực sự muốn xóa mặt hàng này khỏi kho của bạn.
              </Typography>
            </>
          }
