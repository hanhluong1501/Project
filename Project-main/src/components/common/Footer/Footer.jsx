...
const middleSection = {
  title: "Sản phẩm",
  items: [
    { label: "Trang điểm", path: CATEGORY_PATH.MAKE_UP },
    { label: "Chăm sóc da", path: CATEGORY_PATH.SKINCARE },
    { label: "Quà tặng & Bộ", path: CATEGORY_PATH.GIFTS_AND_SETS },
  ],
};
      ...
      >
        <Container maxWidth="lg" sx={containerStyle}>
          ...
          >
            ...
            >
              {new Date().getFullYear()} Beauty Garden 
            </Typography>
          </Box>
          <Box
            sx={{
