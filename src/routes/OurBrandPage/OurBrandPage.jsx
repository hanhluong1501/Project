...
const brandInfo = {
  ...
  about:
    "Tại Beautya, chúng tôi đang trên một sứ mệnh để giải phóng sức mạnh của vẻ đẹp. Mục tiêu của chúng tôi là định nghĩa lại các tiêu chuẩn vẻ đẹp và truyền cảm hứng cho mọi người để họ có thể yêu thương bản thân mình một cách duyên dáng và đặc biệt.",
  story:
    "Ngày xửa ngày xưa, trong một thế giới mê hoặc bởi sức hấp dẫn của vẻ đẹp, câu chuyện của Beautya được hé lộ. Sinh ra từ đam mê về tự biểu hiện và mong muốn tạo ra ảnh hưởng tích cực, Beautya không chỉ là một thương hiệu mỹ phẩm - đó là một hành trình ma thuật tôn vinh sự độc đáo và nghệ thuật yêu thương bản thân",
  brandImages: [
