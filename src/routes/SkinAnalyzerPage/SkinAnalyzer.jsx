    ...
    if (file) {
      ...
      try {
        ...
        const storageRef = ref(
          storage,
          `skin-analyze-images/${compressedFile.name}`
        );
    ...
    <Container maxWidth="md" style={{ marginTop: "40px" }}>
      <Paper elevation={3} style={{ padding: "20px" }}>
        <Typography
          variant="h4"
          gutterBottom
          style={{ color: "var(--primary, #A10550)", textAlign: "center" }}
        >
        ...
        <List>
          ...
          <ListItem>
            <ListItemText
              primary={<b>Kích thước:</b>}
              secondary="Từ 200*200 đến 4096*4096 (pixels)"
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary={<b>Kích thước tệp:</b>}
              secondary="Không lớn hơn 2MB"
            />
          </ListItem>
          <ListItem>
            <ListItemText
              ...
              secondary={
                <>
                  Để đảm bảo độ chính xác của kết quả, nên có duy nhất 1 khuôn
                  mặt trong ảnh.
                </>
              }
            />
          ...
          <ListItem>
            <ListItemText
              ...
              secondary={
                <>
                  Chất lượng khuôn mặt càng cao, phân tích da càng chính xác.
                  Những yếu tố ảnh hưởng đến chất lượng khuôn mặt bao gồm: che
                  phủ các đặc điểm khuôn mặt, ảnh mờ, ánh sáng không đúng (chói,
                  ánh sáng tối, ánh sáng phía sau), góc quay khuôn mặt quá mức
                  (góc cuộn đề xuất ≤ ±45°, góc quay ≤ ±45°, góc nghiêng ≤
                  ±45°), v.v.
                </>
              }
            />
        ...
        >
          {loading && (
            <CircularProgress
              style={{ marginTop: "20px", color: "var(--primary, #A10550)" }}
            />
          )}
        </Box>
        ...
        {analysisResult && (
          <SkinAnalysisResult result={analysisResult.result} />
        )}
      </Paper>
    </Container>
  );
